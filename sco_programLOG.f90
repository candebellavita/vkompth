...
IMPLICIT NONE
    ...
    CALL sco_MODEL_LOG(disk_size, corona_size, Tcorona, Tdisk, tau, QPO_frequency, DHext, eta_frac, Nsss, Ssss,Tsss, &
    ...
    OPEN(UNIT=11, FILE= 'outputLOG.dat')
