      subroutine sco_curfit(iopt,m,x,y,w,xb,xe,k,s,nest,n,t,c,fp,
     * wrk,lwrk,iwrk,ier)
...
c  ..
        !write(*,*) 'xb',xb, 'xe', xe, 'k',k, 's', s, 'nest', nest
        !write(*,*) 'iopt', iopt, 'lwrk',lwrk, 'M', M
...
c we partition the working space and determine the spline approximation.
  40  ifp = 1
      ...
      ig = ib+nest*k2
      iq = ig+nest*k2
      call sco_fpcurf(iopt,x,y,w,m,xb,xe,k,s,nest,tol,maxit,k1,k2,n,t,
