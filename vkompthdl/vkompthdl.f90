SUBROUTINE vkompthdl(ear,ne,param,IFL,photar,photer)
    IMPLICIT NONE
    ...
    DOUBLE PRECISION, save :: pkTs, pkTe, pgam, psize, peta_frac, pqpo_freq, paf, pdL, pear(0:MAXNE)
...
!    INTEGER :: DGNFLT
    ...
    IF (pkTs.eq.param(1).and.pkTe.eq.param(2).and.pgam.eq.param(3).and.psize.eq.param(4).and. &
        ...
        pdL.eq.param(7).and.pne.eq.ne) then
        i=0
