SUBROUTINE vkdualdl(ear,ne,param,IFL,photar,photer)
    IMPLICIT NONE
    ...
    DOUBLE PRECISION, save :: pkTs1, pkTe1, pgam1, pLsize1, peta1, pqpo_freq, paf, pdL1, pear(0:MAXNE)
    DOUBLE PRECISION, save :: pkTs2, pkTe2, pgam2, pLsize2, peta2, pdL2, pphi

    DOUBLE PRECISION Lsize1, kTe1, kTs1, gam1, eta1, dL1
    DOUBLE PRECISION Lsize2, kTe2, kTs2, gam2, eta2, dL2
...
!    INTEGER :: DGNFLT
    ...
    IF (pkTs1.eq.param(1).and.pkTs2.eq.param(2).and.pkTe1.eq.param(3).and.pkTe2.eq.param(4).and. &
        ...
        paf.eq.param(11).and.pdL1.eq.param(12).and.pdL2.eq.param(13).and.pphi.eq.param(14).and.&
        pne.eq.ne) then
        i=0
